...
def test_fetch_info() -> None:
    ...
    expected_issues = {'575ca719383a62db400a8e2b353d5c1482322c13': {'total_count': 1,
  'incomplete_results': False,
  'items': [{'url': 'https://api.github.com/repos/con/nwb2bids/issues/252',
    ...
    'issue_dependencies_summary': {'blocked_by': 0,
     ...
     'blocking': 0,
     'total_blocking': 0},
    'body': '@asmacdo noted that `nwb2bids` takes a long time to run on Dandiset 000008\n\nShould investigate why',
    'reactions': {'url': 'https://api.github.com/repos/con/nwb2bids/issues/252/reactions',
     'total_count': 0,
     '+1': 0,
     '-1': 0,
     'laugh': 0,
